...
namespace Furball.Vixie.Graphics {
    public static class QoiLoader {
        ...
        private static int CalculateIndex(Pixel pixel) {
        ...
        public static (Pixel[] pixels, QoiHeader header) Load(byte[] file) {
            ...
            Pixel[] data = new Pixel[totalPixels];
